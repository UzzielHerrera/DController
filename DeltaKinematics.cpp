...
void DeltaKinematics::begin(void) {
  _deltaE = DELTA_E;
  _deltaF = DELTA_F;
  _deltaRE = DELTA_RE;
  ...
  // Serial.println("Delta Kinematics Module initialized.");
...
MoveDesigner DeltaKinematics::InverseCalculations(Point point, MoveDesigner &md){
  ...
  _realAngle[0] = angle.theta1 * TRANSMISION_RELATION;
  _realAngle[1] = angle.theta2 * TRANSMISION_RELATION;
  _realAngle[2] = angle.theta3 * TRANSMISION_RELATION;
